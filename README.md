...
Once the `conda-forge` channel has been enabled, `mache` can be installed with:

```
conda install mache
```

It is possible to list all of the versions of `mache` available on your platform with:
